<section class="visit-shop" style="background-image: url('<?php echo get_theme_file_uri( 'assets/images/stol-cezar-i-krzesla.jpg' ); ?>');">
	...
	<?php if( have_rows( 'offer_visit_shop' ) ): 
		while( have_rows( 'offer_visit_shop' ) ): the_row(); 

		$heading = get_sub_field( 'offer_visit_shop_title' );
		$sub_heading = get_sub_field( 'offer_visit_shop_sub_title') ; 
		$hours = get_sub_field( 'offer_visit_shop_sub_hours' );
